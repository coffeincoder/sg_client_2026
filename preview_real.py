...
def build_center() -> QWidget:
    ...
    sort_name = make_btn(" По имени", "sort1.png", obj="ghost", icon_px=22, min_h=40, tint="#cfd6e0")
    sort_date = make_btn(" По дате", "sort1.png", obj="ghost", icon_px=22, min_h=40, tint="#cfd6e0")
